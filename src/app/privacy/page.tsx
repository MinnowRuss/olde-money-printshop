      ...
      <div className="space-y-8 text-sm leading-relaxed text-muted-foreground">
        ...
        <section>
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            ...
            <li>
              <strong className="text-foreground">Account Information:</strong> If you sign in
            ...
            <li>
              <strong className="text-foreground">Uploaded Content:</strong> Photos and images
            ...
            <li>
              <strong className="text-foreground">Cookies and Tracking:</strong> We use cookies
